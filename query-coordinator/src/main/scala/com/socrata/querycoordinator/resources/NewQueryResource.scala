        ...
        def innerLoop(chosenSecondaries: Seq[SecondaryResult[String]], retries: Int, secondaries: Queue[SecondaryResult[String]]): (SecondaryResult[String], Response) = {
          ...
          secondaryFinder(chosenSecondary.secondary) match {
            case None =>
              ...
              innerLoop(chosenSecondaries, retries, secondaries)
            case Some(instance) =>
              ...
              respOrRetriableError match {
                ...
                case Left(_) if retries < 3 => innerLoop(chosenSecondaries, retries + 1, remainingSecondaries.enqueue(chosenSecondary))
                case Left(e) => throw e
              }
          }
        }
